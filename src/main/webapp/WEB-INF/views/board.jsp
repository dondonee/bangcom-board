                    ...
                    <ul class="list-unstyled list-inline d-flex justify-content-center m-0">
                        <c:forEach var="topic" items="${topicGroup.topics}">
                            <li class="list-inline-item">
                                <button type="button" class="btn btn-link x-btn-link x-v390-text-sm text-decoration-none px-3 py-1">${topic.description}</button>
                            </li>
                        </c:forEach>
                        <li class="list-inline-item">
                            <button type="button" class="btn btn-link x-btn-link x-v390-text-sm text-decoration-none px-3 py-1">전체</button>
                        </li>
                    </ul>
                </div>
                <div class="order-md-1 col-md-auto col-6 col-sm-6">
                    <button type="button" class="btn btn-primary px-3 py-1"><i class="bi bi-pencil-fill pe-1"></i><span class="x-text-sm">글쓰기</span></button>
                </div>
                <div class="order-md-3 col-md-auto col-6 col-sm-6 text-end">
                    <button type="button" class="btn btn-outline-secondary px-3 py-1"><span class="x-text-sm">최신순</span></button>
                </div>
            </div>
            </c:if>
                    ...
                    <c:forEach var="post" items="${posts}">
                        <li class="py-3 border-top text-decoration-none">
                            ...
                            <div class="d-flex justify-content-end x-text-md" style="line-height: 1.2rem">
                                <i class="me-1 bi bi-eye" style="font-size: 1.2rem"></i><span class="x-text-sm">${post.viewCount}</span>
                            </div>
                        </li>
                    </c:forEach>
                </ul>
