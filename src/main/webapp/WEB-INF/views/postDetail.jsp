                ...
                <div class="mt-4 pb-5 border-bottom">
                    <div class="position-relative">
                        ...
                        <div class="position-relative">
                            <span class="ms-3 px-2 small x-font-light x-text-gray-600 bg-white"><a class="x-link sub"
                                    ...
                                    href="" class="x-link active">${post.topic.description}</a></span>
                        </div>
                    </div>
                    <div class="mt-5 mb-4 d-flex justify-content-between" style="line-height: 1.25rem">
                        ...
                        <div class="dropdown d-flex align-items-center">
                            <button class="dropdown-toggle" style="background: none; border: none;" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-three-dots x-text-gray-700" viewBox="0 0 16 16">
                                    <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3m5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3m5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3"/>
                                </svg>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end x-text-sm x-text-gray-700" aria-labelledby="dropdownMenuButton1">
                                <li><a class="dropdown-item" href="#"><i class="me-1 bi bi-pencil-square"></i>수정하기</a></li>
                                <li><a class="dropdown-item" href="#"><i class="me-1 bi bi-trash3"></i>삭제하기</a></li>
                            </ul>
                        </div>
                            </c:if>
                    </div>
